export const initialPortfolioData = {
  ...
  skills: [
    { id: "s1", name: "React.js", category: "Hard Skills", level: "Expert" },
    { id: "s2", name: "Next.js", category: "Hard Skills", level: "Advanced" },
    { id: "s3", name: "TypeScript", category: "Hard Skills", level: "Advanced" },
    { id: "s4", name: "Tailwind CSS", category: "Hard Skills", level: "Expert" },
    { id: "s5", name: "HTML5 / CSS3", category: "Hard Skills", level: "Expert" },
    { id: "s6", name: "Framer Motion", category: "Hard Skills", level: "Proficient" },
    { id: "s7", name: "Node.js", category: "Hard Skills", level: "Advanced" },
    { id: "s8", name: "Express.js", category: "Hard Skills", level: "Advanced" },
    { id: "s9", name: "Python", category: "Hard Skills", level: "Expert" },
    { id: "s10", name: "FastAPI", category: "Hard Skills", level: "Advanced" },
    { id: "s11", name: "PostgreSQL", category: "Hard Skills", level: "Advanced" },
    { id: "s12", name: "MongoDB", category: "Hard Skills", level: "Proficient" },
    { id: "s13", name: "Redis", category: "Hard Skills", level: "Proficient" },
    { id: "s14", name: "Docker", category: "Hard Skills", level: "Proficient" },
    { id: "s15", name: "PyTorch", category: "Hard Skills", level: "Advanced" },
    { id: "s16", name: "LangChain / Agents", category: "Hard Skills", level: "Advanced" },
    { id: "s17", name: "OpenAI / Claude APIs", category: "Hard Skills", level: "Expert" },
    { id: "s18", name: "Vector Databases (Pinecone/Chroma)", category: "Hard Skills", level: "Advanced" },
    { id: "s19", name: "Git & GitHub", category: "Hard Skills", level: "Expert" },
    { id: "s20", name: "Linux & Bash", category: "Hard Skills", level: "Advanced" },
    { id: "s21", name: "RESTful & GraphQL APIs", category: "Hard Skills", level: "Expert" },
    { id: "s22", name: "CI/CD & DevOps", category: "Hard Skills", level: "Proficient" },
    { id: "s23", name: "Problem Solving", category: "Soft Skills", level: "Expert" },
    { id: "s24", name: "System Architecture & Design", category: "Soft Skills", level: "Expert" },
    { id: "s25", name: "Cross-Functional Collaboration", category: "Soft Skills", level: "Advanced" },
    { id: "s26", name: "Agile & Scrum Methodologies", category: "Soft Skills", level: "Advanced" },
    { id: "s27", name: "Technical Leadership", category: "Soft Skills", level: "Proficient" },
    { id: "s28", name: "Communication & Mentorship", category: "Soft Skills", level: "Advanced" },
    { id: "s29", name: "Analytical Reasoning", category: "Soft Skills", level: "Expert" },
    { id: "s30", name: "Adaptability & Continuous Learning", category: "Soft Skills", level: "Expert" }
  ],
  projects: [
    {
      id: "p1",
