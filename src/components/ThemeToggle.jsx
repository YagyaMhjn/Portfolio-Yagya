...
export const ThemeToggleButton = ({ className = "" }) => {
  ...
  return (
    ...
    >
      ...
      {/* Label expanding smoothly to the right */}
      <span className="max-w-0 opacity-0 group-hover:max-w-[120px] group-hover:opacity-100 group-hover:ml-2 transition-all duration-300 ease-out whitespace-nowrap text-xs font-mono font-medium tracking-wide">
        {isDark ? 'Dark' : 'Light'}
      </span>
    </button>
  );
